...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
            <div class="card-header text-center text-uppercase font-weight-bold">Configuración de mi cuenta</div>
                ...
                <!-- <-> -->
                     ...
                     <!-- Campos Password borrados -->
                    
                     <!-- Mostrar imagen actual -->
                     @if(Auth::user()->image)
                        <div class="form-group row">

                                <label for="image_path" class="col-md-4 col-form-label text-md-right">Current</label>
                                {{-- @include('includes.avatar') tmb se puede esto, asi se include --}}
                                <div class="col-md-6">
                                    <img  class="text-center" src="{{ route('user.avatar', ['filename' => Auth::user()->image]) }}" width="50" height="50" /> {{-- url('user/avatar/'. Auth::user()->image) --}}
                                </div>                                           
                        </div>
                     @endif
